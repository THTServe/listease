...
/// The callback used by [ReorderableListViewNoShadow] to move an item to a new
/// position in a list.
///
...
/// [ReorderableListViewNoShadow] will need to account for this when inserting before
/// [newIndex].
///
...
///
/// {@youtube 560 315 https://www.youtube.com/watch?v=3fB1mxOsqJE}
class ReorderableListViewNoShadow extends StatefulWidget {
  /// Creates a reorderable list.
  ReorderableListViewNoShadow({
    Key key,
    this.header,
  ...
  /// underlying list.
  ///
  /// This [ReorderableListViewNoShadow] calls [onReorder] after a list child is dropped
  /// into a new position.
  final ReorderCallback onReorder;

  @override
  _ReorderableListViewNoShadowState createState() =>
      _ReorderableListViewNoShadowState();
}
...
class _ReorderableListViewNoShadowState
    extends State<ReorderableListViewNoShadow> {
  ...
  final GlobalKey _overlayKey =
      GlobalKey(debugLabel: '$ReorderableListViewNoShadow overlay key');
